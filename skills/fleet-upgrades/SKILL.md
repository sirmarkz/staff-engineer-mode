---
name: fleet-upgrades
description: "Use when asked to plan a runtime, platform, or framework upgrade across many services, clients, or hosts — version skew, support windows, mixed-version compatibility, and rollback path."
---
