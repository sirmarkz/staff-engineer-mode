...
description: "Use when asked to retire a service, sunset an API family, replace a legacy library, or run a broad migration across many call sites — usage telemetry, replacement readiness, batched migration, and no-new-usage controls."
---
...
- `migration_batches`: dependents are grouped into maintained, reviewable, reversible batches.
