...
- Cryptographic agility, certificate expiry, key rotation, and trust-chain lifecycle route to `crypto-lifecycle`; runtime access and secrets policy stays with `identity-and-secrets`.
