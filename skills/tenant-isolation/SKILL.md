...
- Make recommendations actionable with owners, enforcement layers, query/key rules, quotas, tenant-scoped audit logs with retention, test cases, and stop criteria where relevant.
...
- Tenant-scoped audit log requirements, including covered events, protected fields, retention period or retention policy, and review ownership.
