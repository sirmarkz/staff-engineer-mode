...
6. **Make gates owned.** Every blocking check needs an owner, failure instructions, and a path to fix or quarantine.
7. **Handle flakes ruthlessly.** A flaky blocker teaches people to ignore gates. Fix, quarantine, or downgrade with owner and expiry.
