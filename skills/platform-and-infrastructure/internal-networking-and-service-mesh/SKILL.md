...
description: "Use when the user asks about internal service networking, service mesh, internal load balancing, service discovery, internal routing, east-west traffic policy, authenticated service-to-service transport, locality-aware routing, private network connectivity, or cross-region network cost. Do not use for public edge abuse defense."
---
...
- The user asks about internal service networking, service mesh, internal load balancing, service discovery, east-west traffic policy, authenticated service-to-service transport, locality-aware routing, or cross-region network cost.
