...
4. **Check static stability.** Confirm remaining domains already have enough capacity and quotas during the failure. Do not count emergency scaling that depends on the failed domain.
