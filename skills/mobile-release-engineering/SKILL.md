...
- Include numeric stability thresholds and measurement windows when recommending rollout gates; clearly label provisional defaults if the user has not supplied team-specific budgets.
