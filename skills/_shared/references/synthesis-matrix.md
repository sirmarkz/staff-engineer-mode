...
| Risk acceptance and control evidence | Use ISO 31000 and NIST SP 800-39 risk-acceptance lifecycle with review cadence; require accepted deviations to state rationale, compensating controls, owner, expiry, verification evidence, and review cadence; require continuous-monitoring evidence per NIST SP 800-37 Revision 2 RMF Step 7. |
