...
2. **Classify severity.** Use impact radius and urgency: Sev1 for widespread critical user or data/security impact, Sev2 for major but bounded customer impact, Sev3 for limited degradation or internal dependency risk, Sev4 for low-impact anomaly requiring follow-up.
...
6. **Communicate predictably.** Set status cadence by severity; Sev1 should update within 30 minutes or less, Sev2 within an hour, and lower severities by stated owner cadence. Say what is known, unknown, impact, mitigation, and next update time.
